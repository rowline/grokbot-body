/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 548b9c37a0b9a189da20b0b6a5fe33b4)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	BODY: DurableObjectNamespace<import("./src/index").BodyDurableObject>;
	PAIRING: DurableObjectNamespace<import("./src/index").PairingIndex>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BodyDurableObject" | "PairingIndex";
	}
